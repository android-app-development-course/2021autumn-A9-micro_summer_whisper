...
import com.micro_summer_whisper.flower_supplier.order.databinding.Fragment4Binding
    ...
    override fun onCreateView(
        ...
        activity?.let {
            this.context?.let {
                ...
                binding.orderRecyclerview4.adapter = orderAdapter
                val layoutManager = LinearLayoutManager(it)
                binding.orderRecyclerview4.layoutManager = layoutManager
            }
        }
