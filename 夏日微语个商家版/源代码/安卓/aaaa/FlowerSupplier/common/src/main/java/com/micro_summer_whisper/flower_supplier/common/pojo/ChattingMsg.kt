...
class ChattingMsg(val headImageLink: String, val content: String, val msgType: Int, val aId: Long,val bId: Long,val nickName: String,val isText: Boolean): Serializable {
