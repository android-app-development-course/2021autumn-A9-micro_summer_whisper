package com.example.floor_shop.ui.home.diary
...
import com.example.floor_shop.ui.utils.generateRandomTodoItem
 ...
 */
@Composable
fun TodoItemEntryInput(onItemComplete: (TodoItem) -> Unit, buttonText: String = "增加日记") {
